<%@ Page Title="Add Location" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddLocation.aspx.cs" Inherits="CarHireWebApp.AddLocations" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="spacer"></div>
            <asp:Button runat="server" ID="addLocationBtn" Text="Add Location" type="button" class="btn btn-primary" OnClick="LocationAddBtn_Click"></asp:Button>
